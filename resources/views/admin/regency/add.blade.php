...
<section class="content">
    ...
    @endif
    <form enctype="multipart/form-data" method="post" action="{{ route('postAddChucvu') }}" id="form" class="form">
        @csrf
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="name_cv" value="{{ old('email') }}" class="form-control">
                        ...
                        <div class="card-body ">
                            <div class="form-group">
								...
								<select class="form-control" name="pb">
                                    @foreach ($pb as $row )
                                    <option value="{{ $row->id }}" {{ old('role') == $row->id?'selected':'' }}>{{ $row->name_pb }}</option>
                                    @endforeach
								</select>
							</div>
